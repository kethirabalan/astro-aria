...
I previously shared some websites on [Twitter](https://x.com/0xkethirabalanBi) using short links to make it easier to see if people are interested. Among these link shortening systems, Dub provides the best user experience, but it has a fatal flaw: once the monthly clicks exceed 1000, you can no longer view the statistics.
...
[![ccbikethirabalan/sink - GitHub](https://github.html.zone/ccbikethirabalan/sink)](https://github.com/ccbikethirabalan/sink)
...
Finally, feel free to follow me on [Twitter](https://x.com/0xkethirabalanBi) for updates on development progress and to share some web development news.
